...
ETF_ID = "ETF06"
ISIN = "IE00B3VTN290"
TICKER_SOURCE = "SXRQ.DE"   # Yahoo symbol for the LSE line
TICKER_DATASET = "SXRQ"    # ticker you want stored in your dataset
CURRENCY = "EUR"
...
# Save
df.to_csv("ETF06_raw.csv", index=False, encoding="utf-8")

print("Saved ETF06_raw.csv")
print(df.head())
print(df.tail())
print(df.shape)