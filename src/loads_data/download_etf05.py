...
ETF_ID = "ETF05"
ISIN = "IE00B3VWN518"
TICKER_SOURCE = "CBU0.L"   # Yahoo symbol for the LSE line
TICKER_DATASET = "CBU0"    # ticker you want stored in your dataset
CURRENCY = "USD"
...
# Save
df.to_csv("ETF05_raw.csv", index=False, encoding="utf-8")

print("Saved ETF05_raw.csv")
print(df.head())
print(df.tail())
print(df.shape)