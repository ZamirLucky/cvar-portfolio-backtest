...
ETF_ID = "ETF04"
ISIN = "IE00BKM4GZ66"
TICKER_SOURCE = "EMIM.AS"   # Yahoo symbol for the LSE line
TICKER_DATASET = "EMIM"    # ticker you want stored in your dataset
CURRENCY = "EUR"
...
# Save
df.to_csv("ETF04_raw.csv", index=False, encoding="utf-8")

print("Saved ETF04_raw.csv")
print(df.head())
print(df.tail())
print(df.shape)